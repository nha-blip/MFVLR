...
def main() -> int:
    ...
    parser.add_argument("--source-dir", "--source_dir", type=str, default="MFVLR_Dataset/images/real", help="Directory containing source face images")
    ...
    parser.add_argument("--dataset-root", "--output-root", "--dataset_root", type=str, default="MFVLR_Dataset", help="Root directory of MFVLR dataset (default: MFVLR_Dataset)")
    parser.add_argument("--output-dir", "--dest-dir", "--output_dir", type=str, default=None, help="Explicit destination directory for generated fake images (overrides dataset-root/images/AM/<generator>)")
    parser.add_argument("--shard-id", "--shard_id", type=int, default=0, help="Shard index")
    parser.add_argument("--num-shards", "--num_shards", type=int, default=1, help="Total number of shards")
    parser.add_argument("--start-index", "--start_index", type=int, default=None, help="Explicit start index")
    parser.add_argument("--end-index", "--end_index", type=int, default=None, help="Explicit end index")
    ...
    parser.add_argument("--batch-size", "--batch_size", type=int, default=1, help="Batch size for DiffAE generation (recommended: 2 or 4 on Colab GPU)")
